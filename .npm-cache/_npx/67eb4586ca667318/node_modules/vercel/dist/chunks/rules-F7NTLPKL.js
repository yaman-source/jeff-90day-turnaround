...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-LV3EOIGK.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-LV3EOIGK.js")).default(client, args);
    case "add":
      return (await import("./add-6XIRI7GJ.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-45WAIMAY.js")).default(client, args);
    case "rm":
      return (await import("./rm-MMZJTUSV.js")).default(client, args);
    case "update":
      return (await import("./update-LSMYRPF7.js")).default(client, args);
    default:
